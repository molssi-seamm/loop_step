...
Installation
============
The Loop step is probably already installed in your SEAMM environment, but
...
check for `loop-step`. If it is not installed, or can be updated, check the box
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update loop-step
